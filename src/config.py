...
FLAT_TO_NESTED = {
    ...
    "IDE_BRIDGE_HOST": ("ide_bridge", "host"),
    "IDE_BRIDGE_PORT": ("ide_bridge", "port"),
    "IDE_BRIDGE_TOKEN": ("ide_bridge", "token"),
    "feature_pet_interaction": ("features", "pet_interaction"),
    "feature_activity_tracking": ("features", "activity_tracking"),
    "feature_autonomous_behavior": ("features", "autonomous_behavior"),
    "feature_memory_sync": ("features", "memory_sync"),
    ...
    "BUBBLE_MAX_CHARS": ("visuals", "bubble_max_chars"),
    ...
    "BUBBLE_MS_PER_CHAR": ("behavior", "bubble_ms_per_char"),
    "BUBBLE_MIN_DURATION_MS": ("behavior", "bubble_min_duration_ms"),
    "BUBBLE_MAX_DURATION_MS": ("behavior", "bubble_max_duration_ms"),
    "DIALOGUE_MAX_LENGTH": ("behavior", "dialogue_max_length"),
    "TYPEWRITER_TICK_MS": ("visuals", "typewriter_tick_ms"),
    "TYPEWRITER_CHARS_PER_TICK": ("visuals", "typewriter_chars_per_tick"),
...
NESTED_TO_FLAT = {
    ...
    ("storage", "brain_path"): "BRAIN_PATH",
    ("storage", "session_path"): "SESSION_PATH",
    ...
    ("visuals", "bubble_max_chars"): "BUBBLE_MAX_CHARS",
    ...
    ("behavior", "bubble_ms_per_char"): "BUBBLE_MS_PER_CHAR",
    ("behavior", "bubble_min_duration_ms"): "BUBBLE_MIN_DURATION_MS",
    ("behavior", "bubble_max_duration_ms"): "BUBBLE_MAX_DURATION_MS",
    ("behavior", "dialogue_max_length"): "DIALOGUE_MAX_LENGTH",
    ("visuals", "typewriter_tick_ms"): "TYPEWRITER_TICK_MS",
    ("visuals", "typewriter_chars_per_tick"): "TYPEWRITER_CHARS_PER_TICK",
